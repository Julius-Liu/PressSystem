...
<script type="text/javascript">
	...
	function updateAssetsBalance(){
		...
		form.action = "<%=basePath%>assets_balance/updateAssetsBalance";
		form.method="post";
		form.submit();
	}
...
<TABLE align="center" height="100%" cellSpacing=0 cellPadding=0 width="80%" border=0>
  ...
  <TR>
	...
	<tr>
	    <td width=30%>资金编号：</td>
	    <td width=70%><input id="id" name="id" value="${assetsBalance.id}" type="hidden" /></td>
	</tr>
	...
	<tr>
  	...
  	<tr>
    	<td width=30%>科目名称：</td>
    	<td width=70%><input id="department_title" name="department_title" value="${assetsBalance.department_title}" type="text" size="15" /></td>
  	</tr>

	<tr>
    	<td width=30%>客户名称：</td>
    	<td width=70%><input id="customer_name" name="customer_name" value="${assetsBalance.customer_name}" type="text" size="20" /></td>
  	</tr>
  	...
  	<tr>
    	<td width=30%>银行：</td>
    	<td width=70%><input id="bank_name" name="bank_name" value="${assetsBalance.bank_name}" type="text" size="15" /></td>
  	</tr>
  	...
  	<tr>
    	...
    	<td width=70%><input id="record_create_date" name="record_create_date" value="${assetsBalance.record_create_date}" type="text" size="10" readonly onclick="setDay(this);"/></td>
  	</tr>

  	<tr bgcolor='#FFFFFF'>
      	<td colspan="4" align="center">
        	<input type='submit' name='button' value='保存' onclick="updateAssetsBalance()">
        	&nbsp;&nbsp;
