...
<script type="text/javascript">
	...
	function QueryBook4FaXing() {
		document.forms["faXing"].action = "<%=basePath%>fa_xing/queryBook4FaXing";
		document.forms["faXing"].method = "post";
		document.forms["faXing"].submit();
	}
  ...
  <TR>
	...
	<tr>
		...
		<td>
			...
			<input type="submit" value="查询" onclick="QueryBook4FaXing();"  />
		</td>
	</tr>
	...
	<tr>
  	...
  	<tr>
    	<td width=30%>账号：</td>
    	<td width=70%><input id="bank_account" name="bank_account" value="${faXing.bank_account}" type="text" size="25" /></td>
  	</tr>
  	<tr>
    	<td width=30%>配书人：</td>
